...
import { ChevronLeft, Share2, Plus, BarChart2, Loader2, CheckCircle2, Crown, Send, Bot, Star, Sparkles } from 'lucide-react'
        ...
        <div className="flex-1">
          {loading && !explanation ? (
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-[18px] font-extrabold tracking-tight">theLemma</span>
            </div>
          ) : (
